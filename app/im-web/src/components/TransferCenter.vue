...
button { cursor: pointer; border: 1px solid var(--border-light, #ddd); border-radius: 7px; padding: 6px 10px; background: transparent; color: inherit; } button:disabled { opacity: .5; cursor: default; } button:focus-visible { outline: 2px solid var(--accent, #F87B08); }
nav { display: flex; gap: 8px; margin: 20px 0 12px; } nav .selected { background: var(--accent, #F87B08); color: white; }
...
.transfer-conversation { margin-top: 6px; font-size: 12px; border: 0; padding-left: 0; color: var(--accent, #F87B08); } .transfer-status { margin: 8px 0; font-size: 13px; } .transfer-detail { font-size: 12px; color: var(--text-tertiary, #777); overflow-wrap: anywhere; } .transfer-error,.error { color: var(--danger-strong, #E5484D); font-size: 12px; overflow-wrap: anywhere; } progress { width: 100%; accent-color: var(--accent, #F87B08); height: 6px; } .transfer-actions { display: flex; gap: 6px; flex-wrap: wrap; font-size: 12px; } .transfer-empty { margin-top: 40px; text-align: center; color: var(--text-tertiary, #777); }
</style>
